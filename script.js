...
const CONFIG = {
    ...
    youtubeUrl: "https://www.youtube.com/watch?v=pedRiXAgYJg",
    textos: {
        cat1: { t: "QUIÉNES SOMOS", c: "Nacimos con una sola misión: ¡llevar el auténtico sabor de las mejores carnitas a tu mesa! Nos encanta consentirte en tus reuniones familiares y momentos especiales con nuestra receta tradicional, carne fresca y el chicharrón más crujiente salido del cazo al momento." },
        cat2: { t: "ESTO NOS HACE DIFERENTES", c: "En nuestro restaurante de carnitas te damos un servicio de la mejor calidad en la preparación de orden, tacos bien reportados y paquetes familiares, para que tú solo disfrutes tu reunión" },
        cat3: { t: "CLIENTES FELICES", c: "Nuestros clientes, tanto locales como los que nos visitan de fuera, nos eligen y recomiendan por nuestro gran sabor, servicio, calidad y carne siempre fresca, reconociendo nuestra gran tradición en cada uno de nuestros restaurantes de carnitas" }
    },
    sucursales: {
...
function renderGallery(cat) {
    ...
    if (cat === 'cat3' || cat === 'cat2') {
        ...
        if (cat === 'cat3') {
            ...
            videoContainer.innerHTML = `
                <a href="https://www.youtube.com/shorts/l89o0cz_nZw" target="_blank" style="background: #b00; color: #fff; padding: 12px 25px; border-radius: 12px; text-decoration: none; font-weight: 900; font-size: 0.9rem;">
